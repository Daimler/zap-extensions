...
public class SarifResult implements Comparable<SarifResult> {
	...
	public static class SarifResultBuilder {
		...
		public SarifResult build() {
			...
			resultLocation.physicalLocation.region.snippet = SarifMessage.builder().setContentAsPlainText(attack)
					.build();

			long startLine = SarifBodyStartLineFinder.DEFAULT.findStartLine(webResponse.body, attack);
